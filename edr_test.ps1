...
1..5 | ForEach-Object {
    "Contenu confidentiel fichier $_`nDonnées sensibles..." | Set-Content "$testDir\document_$_.txt"
}

# Chiffrement XOR simulé
$key = [byte]0x42
$count = 0
...
Log-Result "T1486" "File encryption simulation ($count files)" "EXECUTED" $testDir
